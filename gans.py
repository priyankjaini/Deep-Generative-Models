...
d_sampler = get_distribution_sampler(data_mean, data_stddev) # generates data from gaussian
gi_sampler = get_generator_input_sampler() # generates data uniformly at random
