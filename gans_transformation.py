...
DATASET = '8gaussians' # to add further functionalities
DIM = 4 # model dimensionality
FIXED_GENERATOR = False # whether to hold the generator fixed at real datapoints
LAMBDA = .1
CRITIC_ITERS = 5
BATCH_SIZE = 256
ITERS = 10000
use_cuda = False # True or False
...
def generate_image(true_dist):
    '''
    Generates and saves a plot of the true distribtuion, the generator, and the critic
    '''
